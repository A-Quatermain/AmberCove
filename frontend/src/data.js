...
export const SERVICES = [
  ...
  {
    num: "04",
    title: "Built-In BBQs & Appliances",
    description:
...
export const PORTFOLIO = [
  ...
  {
    image:
      "https://images.unsplash.com/photo-1781004896692-e662dc20fe24?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NTYxODd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBwZXJnb2xhJTIwYmFja3lhcmQlMjBldmVuaW5nJTIwbGlnaHRpbmd8ZW58MHx8fHwxNzg1ODk4NTEyfDA&ixlib=rb-4.1.0&q=85&w=1000",
    title: "Azure Courtyard",
    location: "Delray Beach, FL",
    category: "Pergola & Hardscape",
  },
  {
    image:
  ...
  {
    image:
      "https://images.unsplash.com/photo-1783125126717-e9c855c86a63?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NTYxOTF8MHwxfHNlYXJjaHwyfHxsdXh1cnklMjBvdXRkb29yJTIwa2l0Y2hlbnxlbnwwfHx8fDE3ODU4OTg0MzR8MA&ixlib=rb-4.1.0&q=85&w=1000",
    title: "Aventura Modern",
...
export const STATS = [
  { number: 15, suffix: "+", label: "Years of Craft" },
  { number: 400, suffix: "+", label: "Projects Completed" },
  { number: 98, suffix: "%", label: "Client Satisfaction" },
  { number: 12, suffix: "", label: "Cities Served" },
];

export const PROCESS = [
  { step: "01", title: "Discovery", desc: "On-site consultation to understand your vision, lifestyle, and your property's unique potential." },
  { step: "02", title: "Design", desc: "3D renderings and material selections presented for your review, refined until perfect." },
  { step: "03", title: "Build", desc: "Expert craftsmen execute every detail with premium materials and meticulous oversight." },
  { step: "04", title: "Reveal", desc: "Your completed outdoor living space, ready for a lifetime of memories and gatherings." },
];

export const TESTIMONIALS = [
  {
    quote:
      "Amber Cove transformed our backyard into a destination. The outdoor kitchen alone has changed how we entertain — our guests never want to leave.",
    name: "Michael & Lauren R.",
    title: "Homeowners — Boca Raton",
    image:
      "https://images.unsplash.com/photo-1615464670798-6e92fafa2a89?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1OTN8MHwxfHNlYXJjaHwyfHxoYXBweSUyMHdvbWFuJTIwcG9ydHJhaXQlMjBvdXRkb29yfGVufDB8fHx8MTc4NTg5ODQ0Nnww&ixlib=rb-4.1.0&q=85&w=400",
  },
  {
    quote:
      "As an architect, I need partners who execute at the highest level. Amber Cove consistently delivers craftsmanship that matches and exceeds my design intent.",
    name: "David Chen, AIA",
    title: "Principal — Coastal Modern Architecture",
    image:
      "https://images.unsplash.com/photo-1544225917-1bf66feace19?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA2MDV8MHwxfHNlYXJjaHwyfHxhcmNoaXRlY3QlMjBwb3J0cmFpdHxlbnwwfHx8fDE3ODU4OTg0MzR8MA&ixlib=rb-4.1.0&q=85&w=400",
  },
  {
    quote:
      "They understood the brief immediately — clean lines, premium materials, zero compromise. The result elevated our entire listing and helped us close above asking.",
    name: "Samantha Torres",
    title: "Luxury Real Estate — Aventura",
    image:
      "https://images.unsplash.com/photo-1581065178047-8ee15951ede6?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1NTJ8MHwxfHNlYXJjaHwyfHxwcm9mZXNzaW9uYWwlMjByZWFsJTIwZXN0YXRlJTIwYWdlbnQlMjBwb3J0cmFpdHxlbnwwfHx8fDE3ODU4OTg0NDZ8MA&ixlib=rb-4.1.0&q=85&w=400",
  },
];

export const AREAS = [
  "Delray Beach", "Boca Raton", "Wellington", "Aventura", "Coral Gables",
  "Fort Lauderdale", "Palm Beach", "Parkland", "Weston", "Jupiter",
];
